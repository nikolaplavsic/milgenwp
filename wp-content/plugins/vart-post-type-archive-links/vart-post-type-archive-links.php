<?php  
/* 
Plugin Name: Vart Post Type Archive Links 
Version: 1.0 
...
class Vart_Post_Type_Archive_Link {  
    ...
    public function load(){  
	    ...
	    add_action('wp_ajax_vart-add-post-type-archive-links', array( __CLASS__, 'ajax_add_post_type'));  
	...
	public function add_meta_box() {  
	    add_meta_box( 'post-type-archives', __('Post Types','vart-post-type-archive-links'),array(__CLASS__,'metabox'),'nav-menus' ,'side','low');  
	}  
	...
	public function metabox_script($hook) {  
	    ...
	    wp_enqueue_script( 'vart-post-type-archive-links_metabox', plugins_url('/metabox.js', __FILE__), array('jquery'));  
	  
	    //Add nonce variable  
	    wp_localize_script('vart-post-type-archive-links_metabox','VartPostTypeArchiveLinks', array('nonce'=>wp_create_nonce('vart-add-post-type-archive-links')));  
	}  
	...
	public function ajax_add_post_type() {  
	    ...
	    check_ajax_referer('vart-add-post-type-archive-links', 'posttypearchive_nonce');  
...
Vart_Post_Type_Archive_Link::load();  
?>  